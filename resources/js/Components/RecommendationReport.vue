<template>
  ...
  <template v-else>
    ...
    <article v-if="directions.length" class="panel">
      ...
      <p class="summary-text">Основной вариант выбран по совпадению навыков и достаточному числу вакансий. Грейд пользователя и рыночный уровень профессии считаются отдельно.</p>
      ...
      <section v-if="activeDirection" class="direction mt-4">
        ...
        <p class="mt-1 text-sm text-[#616161]">Профессии ниже подходят по выбранным навыкам. Рыночный уровень показывает положение профессии по зарплатам внутри направления, а не ваш личный грейд.</p>
