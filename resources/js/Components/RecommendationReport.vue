...
watch(() => props.result?.report_uuid, () => { activeDirectionIndex.value = 0; activeRoleId.value = null; });
watch(() => activeDirection.value?.group_id, () => { activeRoleId.value = null; });
